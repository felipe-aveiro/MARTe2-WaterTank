...
- [**_DataVisualization_**](DataVisualization)
  ...
  - [_Outputs_](DataVisualization/Outputs)
    ...
    - [_SDAS-Data_](DataVisualization/Outputs/SDAS-Data)
      - Includes vertical and radial current request signals acquired during experimental discharges saved as CSV files exported from the SDAS system
